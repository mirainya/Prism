...
// 映射配置类型
interface FieldMapping { stdField: string; vendorField: string }
interface ValueMapping { field: string; stdValue: string; vendorValue: string }
interface FixedParam { name: string; value: string }
interface TypeConvert { field: string; type: 'string_to_array' | 'array_to_string'; separator: string }
...
const CONFIG_TEMPLATES: Record<string, {
    ...
    openai_image: {
        ...
        form: { result_mode: 'sync', request_path: '/v1/images/generations', content_type: 'application/json', auth_location: 'header', auth_key: 'Authorization', auth_value_prefix: 'Bearer ' },
        paramFieldMappings: [],
        respFieldMappings: [
    ...
    midjourney_poll: {
        label: 'Midjourney (轮询)',
        description: '提交 + 轮询模式',
        form: { result_mode: 'poll', request_path: '/mj/submit/imagine', content_type: 'application/json', auth_location: 'header', auth_key: 'mj-api-secret', auth_value_prefix: '', poll_path: '/mj/task/{task_id}/fetch', poll_method: 'GET', poll_interval: 10, poll_max_attempts: 60 },
