...
func TestCatalogPricingRequiresCompleteReleaseSpecificRates(t *testing.T) {
	for _, test := range []struct {
		...
		{"unpriced_sku", `INSERT INTO gw_skus VALUES (2,1)`, false},
		...
		{"plan_without_rates", `INSERT INTO gw_cost_plans VALUES (2,1,1)`, false},
		...
		t.Run(test.name, func(t *testing.T) {
			...
			for _, query := range []string{
				...
				`INSERT INTO gw_skus VALUES (1,1)`,
