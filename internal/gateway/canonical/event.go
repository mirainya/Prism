...
const (
	...
	EventReasoningPartAdded EventType = "response.reasoning_summary_part.added"
	EventReasoningTextDone  EventType = "response.reasoning_summary_text.done"
	EventReasoningPartDone  EventType = "response.reasoning_summary_part.done"
	EventProviderProof      EventType = "response.provider_proof"
